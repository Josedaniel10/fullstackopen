...
const commentRouter = require("./controllers/comment.controller.js")
...
app.use(URL_API, commentRouter)

if (process.env.NODE_ENV === "test") {
  const testingRouter = require("./controllers/testing.controller.js");
